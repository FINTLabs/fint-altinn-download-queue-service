package no.novari.downloadqueue.service
...
import no.novari.downloadqueue.repository.AltinnApplicationRepository
import no.novari.downloadqueue.util.DownloadQueueObjectFactory
import no.novari.downloadqueue.service.AltinnApplicationService
